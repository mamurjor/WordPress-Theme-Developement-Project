						...
						<div class="row">
							<div class="col-12">
								<div class="single-main">
									<!-- News Head -->
									<div class="news-head">
                 <?php the_post_thumbnail('large',['class' => 'hadi jaman', 'title' => 'Feature image']);?>
                  ...
                  <?php echo the_title();?>
                   ...
                   <?php the_content();?>
                            ...
                            have suffered alteration in some form, by injected humour, or randomised words Mirum est notare quam littera gothica, quam nunc putamus parum claram, anteposuerit litterarum formas</p>
													<a href="#"><i class="fa fa-reply"></i>replay</a>
												</div>
											</div>
										</div>		
						...
						<div class="main-sidebar">
							...
							<div class="single-widget category">
								...
								<?php foreach(get_categories() as $singlecate) {									
									?>
										<li><a href="<?php echo esc_url(get_category_link($singlecate->term_id));?>"><?php echo  esc_html($singlecate->name); ?></a></li>
							...
							<div class="single-widget side-tags">
								...
								?>
									<li><a href="<?php echo esc_url(get_category_link($single_tag->term_id));?>"><?php echo  esc_html($single_tag->name);?></a></li>
								<?php 
