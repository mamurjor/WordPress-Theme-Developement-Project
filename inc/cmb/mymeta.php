...
function yourprefix_register_demo_metabox() {
	...
	$cmb_demo->add_field( array(
		'name'       => esc_html__( 'Add Class Name', 'learnwp' ),
		'desc'       => esc_html__( 'Icon Class', 'learnwp' ),
		'id'         => 'iconclass',
		'type'       => 'text',		
	) );

	$cmb_demo->add_field( array(
		'name'       => esc_html__( 'Add Booking URL', 'learnwp' ),
		'desc'       => esc_html__( 'Add Booking URL', 'learnwp' ),
		'id'         => 'bookingurl',
		'type'       => 'text_url',		
	) );

	$cmb_demo->add_field( array(
		'name'       => esc_html__( 'Add Pacakge Price', 'learnwp' ),
		'desc'       => esc_html__( 'Add Pacakge Price', 'learnwp' ),
		'id'         => 'package_price',
		'type'       => 'text',		
	) );
...
function yourprefix_register_repeatable_group_field_metabox() {
	...
	$group_field_id = $cmb_group->add_field( array(
		...
		'options'     => array(
			'group_title'    => esc_html__( 'Fature {#}', 'cmb2' ), // {#} gets replaced by row number
